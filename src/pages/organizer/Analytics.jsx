...
import { Users, Trophy, ClipboardCheck, UserCog } from 'lucide-react'
...
export default function Analytics() {
  ...
  const myVolunteerSignups = volunteerSignups.filter(
    (s) => myHackathons.some((h) => h.id === s.hackathon_id) && s.status === 'accepted',
  )
  ...
  return (
    <DashboardShell role="organizer" title="Analytics" subtitle="Live engagement and performance across the events you created.">
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard label="Approved Volunteers" value={myVolunteerSignups.length} icon={UserCog} accent="organizer" />
      </div>
